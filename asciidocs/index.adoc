...
<.> `type="module"` acitvates the module system. In Node.js the native module system is *CommonJS*.
...
TIP: We do not need Snowpack at the moment, because you find the js-redux-file in `/node_modules/redux/es/redux.mjs`
